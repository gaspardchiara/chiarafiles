<%-- 
    Document   : error
    Created on : 5 mai 2020, 17:40:09
    Author     : gaspard
/*
...
<script src="/static/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
  ...
  <div class="container">
    <h1 class="mt-5">Oops an error occcured during your request !</h1>
    <p class="lead">Perhaps you try to upload a file with a size superior at 32 MB.  </p>
    <p class="lead">If not, please reminder Chiarafile is on beta ... try in a few time ! and if not corrected create a pull request to try to reproduce the bug</p>
