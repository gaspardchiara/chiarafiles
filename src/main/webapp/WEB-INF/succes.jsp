<%-- 
    Document   : succes
    Created on : 5 mai 2020, 13:20:39
    Author     : gaspard
/*
...
<script src="/static/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
  ...
  <div class="container">
    <h1 class="mt-5">Great the file : ${filename} is uploaded !</h1>
    <p class="lead">The share link ${displaysharelink}.   or click <a href="${sharelink}">here to see the file </a></p>
    <p class="lead">The delete link  ${displaydellink}.   or click <a href="${dellink}"> to delete the file. </a>  </p>
    <p class="lead">The file will be available during 3 days, after this time it will be deleted from our database.</p>
    <p class="lead">Thannks for using chiarafile !</p>
  </div>
